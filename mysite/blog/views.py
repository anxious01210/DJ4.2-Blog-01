...
def post_detail(request, year, month, day, post):
    ...
    # print('Similar Posts: ', similar_posts)
    # print('Annotate: ', similar_posts.annotate(same_tags=Count('tags')))
    # similar = similar_posts.annotate(same_tags=Count('tags'))
    # print('similar 0 ==> ', similar[0].same_tags)
    # print('similar 1 ==> ', similar[1].same_tags)
